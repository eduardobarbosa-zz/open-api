# barbosa OpenAPI Specification
[![Build Status](https://travis-ci.org/eduardobarbosa/open-api.svg?branch=master)](https://travis-ci.org/eduardobarbosa/open-api)
...
6. If you did everything correct, https://eduardobarbosa.github.io/open-api/ will lead to your new docs
...
- Documentation(ReDoc): https://eduardobarbosa.github.io/open-api/
- SwaggerUI: https://eduardobarbosa.github.io/open-api/swagger-ui/
- Look full spec:
    + JSON https://eduardobarbosa.github.io/open-api/swagger.json
    + YAML https://eduardobarbosa.github.io/open-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://eduardobarbosa.github.io/open-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://eduardobarbosa.github.io/open-api/ with url from the message: `Server started <url>`
